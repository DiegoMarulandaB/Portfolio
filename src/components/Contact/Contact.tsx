            ...
            <div className="md:w-4/1">
              <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-1">
                ...
                <div className="md:5/12 lg:w-5/2">
                  <h2 className=" pl-10 mb-2 mx-1 mr-1 text-center text-2xl font-semibold justify-center">Contact Me</h2>
                  <div className="flex pl-10 mb-12 mx-1 mr-1 text-center justify-center">
                    <a
