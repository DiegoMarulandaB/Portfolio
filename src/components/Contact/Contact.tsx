          ...
          <div className="flex flex-col ml-2 mx-1 mr-1">
            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-1">
              ...
              <div className="md:5/12 lg:w-5/2">
                <div className="pt-16 mr-4 mt-2 mb-4 text-2xl font-semibold flex flex-col items-start text-start justify-start md:items-center md:text-center md:justify-center">
                  <h2>Contact Me</h2>
                </div>
                <div className="flex flex-col-row items-start text-start justify-start md:items-center md:text-center md:justify-center">
                  ...
                  >
                    <span className="relative text-center cursor-pointer mr-4 mt-2 text-1xl text-white bg-slate-600 hover:bg-slate-950 font-medium rounded-full text-sm px-2.5 py-2.5 me-1 mb-1 dark:text-slate-950 dark:bg-slate-50 dark:hover:bg-blue-100">
                      Email →
                    </span>
                  </a>
                  <a
