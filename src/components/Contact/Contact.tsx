            ...
            <div className="md:w-4/2">
              <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-1">
                ...
                <div className="md:5/12 lg:w-5/2">
                  <h2 className=" mx-2 mr-2 mt-4 mb-2 text-center text-2xl font-semibold justify-center">Contact Me</h2>
                  <div className="flex mx-2 mr-2 mt-4 mb-12 text-center justify-center">
                    <a
