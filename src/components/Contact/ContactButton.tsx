...
const ContactButton: React.FC = () => {
  return (
    <div className="flex flex-col-row items-start text-start justify-start md:items-center md:text-center md:justify-center">
      <a
        href="mailto:%20diegomjobs@gmail.com%20?Subject=Aquí%20el%20asunto%20del%20mail"
        className="text-slate-700 hover:text-slate-950 dark:text-white dark:hover:text-blue-100"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contact me by email"
      >
        <span className=" buttons buttons-email mr-4 mt-2 px-2.5 py-2.5 me-1 mb-1 border border-transparent">
          Email →
        </span>
      </a>
      <a
        href="https://www.linkedin.com/in/diegomarulandabarrientos/"
        className="text-slate-700 hover:text-slate-950 dark:text-white dark:hover:text-slate-50"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Visit my LinkedIn profile"
      >
        <span className="buttons mr-4 mt-2 px-2.5 py-2.5 me-1 mb-1 border border-transparent">LinkedIn →</span>
      </a>
      <a
        href="https://github.com/DiegoMarulandaB"
        className="text-slate-700 hover:text-slate-950 dark:text-white dark:hover:text-slate-50"
        ...
        aria-label="Visit my GitHub profile"
      >
        <span className="buttons mr-4 mt-2 px-2.5 py-2.5 me-1 mb-1 border border-transparent">GitHub →</span>
      </a>
    </div>
  )
}
