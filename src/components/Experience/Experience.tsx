...
const Experience = () => {
  ...
  return (
    <section id="experience" className="pt-28 mt-[-1px] mb-6 sm:mb-0">
      <div className="heading-2 mx-auto lg:px-8 max-w-screen-lg sm:px-6 mt-[-1px] sm:mt-0">
            ...
            <div className="md:w-5/12 lg:w-5/12">
              <div className="flex flex-col items-start text-start justify-start md:items-center md:text-center md:justify-center">
                <div className="flex flex-col items-start text-start justify-end md:items-center md:text-center md:justify-center mr-12">
                  {svgLoaded && (
                    <img
                      className="hidden md:block mr-33 ml-30 mt-[-78px] aspect-auto object-cover"
                      src={svgSrc}
                      alt="image developer"
                      width="220"
                      height="220"
