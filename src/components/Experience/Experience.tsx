...
const Experience = () => {
  return (
    <section id="experience" className="pt-28">
      <div className="mx-2 ml-10 font-extrabold capitalize text-4xl sm:text-6xl md:text-4xl lg:text-4xl xl:text-7xl text-start">
        <h1>Experience</h1>
      </div>
        ...
        <div className="md:w-4/5">
          <div className="space-y-6 md:flex md:gap-6 lg:items-start lg:gap-12">
            <div className="md:w-7/12">
              <p className="mb-4 mt-2 ml-8 mx-2 mr-2 text-lg text-start">
