    ...
    <section id="footer">
      <div className=" mx-auto max-w-full md:max-w-full sm:px-1 bg-slate-100 dark:bg-slate-700">
        ...
        <div className="mx-auto flex flex-col items-center justify-center text-center md:flex-row md:justify-evenly">
          <div className="flex flex-row space-x-2 mt-2 mb-2 ml-14 mr-14">Diego Marulanda. | All Rights Reserved.</div>
          <div className="flex flex-row space-x-2 mt-2 mb-2 ml-12 mr-12">&copy;&nbsp;2023 - 2024</div>
        </div>
      </div>
    </section>
  )
