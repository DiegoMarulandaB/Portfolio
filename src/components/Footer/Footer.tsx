...
const Footer = () => {
  return (
    <section
      id="footer"
      className=" mx-auto max-w-full md:max-w-full  px-1 sm:px-1  bg-slate-100  dark:bg-slate-700 mt-12"
    >
      ...
      <div className="mx-auto p-4 flex flex-col items-center justify-center text-center md:flex-row md:justify-evenly">
        <div className="flex flex-row items-center justify-start space-x-2   mt-2 mx-16 mr-16   text-neutral-800 dark:text-neutral-100">
          &copy; {new Date().getFullYear()} Diego Marulanda. | All Rights Reserved.
          <a href="/" className="hover:underline" />
        </div>
        <div className="flex flex-row items-center justify-end space-x-2  mt-2  mx-16 mr-16">
