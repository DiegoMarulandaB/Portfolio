            ...
            <div className="md:w-3/5">
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="text-center text-1xl mx-2 mr-2 mt-4 mb-4">
                  ...
                  <p className="mb-4 mt-4">
                    But at the moment i have not had the opportunity to enter the technology sector. Therefore, i will
                    get my experience through the different projects that i carry out.
                  </p>
                </div>
