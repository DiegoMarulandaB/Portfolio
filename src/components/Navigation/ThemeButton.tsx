    ...
    <>
      {currentTheme === 'dark' ? (
        <button
          ...
          className="bg-purple-300 hover:bg-purple-400 rounded-lg cursor-pointer px-2 py-2 font-bold sm:px-2 sm:py-2 md:px-2 md:py-2 lg:px-2 lg:py-2 xl:px-2 xl:py-2"
