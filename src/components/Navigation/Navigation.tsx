...
//           <Link href="/#home">
//             <div className="container flex items-center space-x-2">
//               <h2 className="h2-header cursor-pointer mr-32">Dago zapata</h2>
//             </div>
//           </Link>
//           {/* mobile menu */}
//           <div className="md:hidden">
...
//           </div>
//         </div>
//         <div className={`md:flex md:items-center md:justify-center mt-4 md:mt-0 ${navigation ? 'block' : 'hidden'}`}>
//           <MenuNav />
//         </div>
//       </div>
//     </header>
