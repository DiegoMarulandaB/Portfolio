        ...
        <div>
          <div className="flex items-center justify-between py-3 md:py-5 md:block  ">
            ...
            <div className="md:hidden">
              <button
                className="p-2 text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 hover:bg-gradient-to-br rounded-r-lg cursor-pointer px-2 py-2 sm:text-1xl md:text-6xl lg:text-7xl xl:text-6xl font-bold"
