  ...
  return (
    <header className="w-full mx-auto px-4 sm:px-30 fixed top-0 z-50 shadow bg-white dark:bg-slate-800 dark:border-b dark:border-sky-500 ">
      <div className="justify-between  md:items-center md:flex  ">
          ...
          <div className="flex items-center justify-between py-3 md:py-5 md:block  ">
            <Link href="/">
              <div className="container flex items-center space-x-2">
                <h2 className="text-2xl font-bold transition-transform cursor-pointer sm:text-1xl md:text-2xl lg:text-2xl xl:text-4xl  ">
                  Diego Marulanda
                </h2>
              </div>
            </Link>
            ...
            <div className="md:hidden">
              <button
                className="p-2 text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 hover:bg-gradient-to-br rounded-r-lg cursor-pointer px-2 py-2 text-3xl sm:text-2xl md:text-6xl lg:text-7xl xl:text-6xl font-bold"
        ...
        <div>
          <div
            className={`flex-1 justify-self-center pb-3 mt-8 md:block md:pb-0 md:mt-0 decoration-sky-600 transition-transform cursor-pointer sm:text-1xl md:text-1xl lg:text-1xl xl:text-2xl  ${
