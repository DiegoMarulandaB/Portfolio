...
const ProjectsCardsDescription: React.FC<{ showCard: string }> = ({ showCard }) => {
  return (
    <div className="mb-16 max-w-screen-xl mx-auto px-4">
      <div className="flex flex-wrap -mx-4">
        ...
        <ProjectsCardsCategoryTitle
          ...
          category="Personal Projects"
          title="Arkanoid clone game"
          description="Arkanoid (1986) is a block-breaking arcade game, developed and published by Taito. Based on a Midudev clone, this project recreates the classic game experience. Technologies: HTML, CSS and JavaScript."
          // buttonDemo="Demo →"
          // buttonHrefDemo="https://github.com/DiegoMarulandaB/Arkanoid-clone-with-JavaScript"
          // hrefDemo="https://github.com/DiegoMarulandaB/Arkanoid-clone-with-JavaScript"
          button="Github →"
        ...
        <ProjectsCardsCategoryTitle
          ...
          category="Personal Projects"
          title="Calculator basic"
          description="Project inspired by Free Code Camps basic React course, ideal for learning and practicing. It offers an interactive and functional experience for the user.Technologies: Vite compiler, React library."
          // buttonDemo="Demo →"
          // buttonHrefDemo="https://github.com/DiegoMarulandaB/interactive-calculator-react"
          // hrefDemo="https://github.com/DiegoMarulandaB/interactive-calculator-react"
          button="Github →"
        ...
        <ProjectsCardsCategoryTitle
          ...
          category="Academic Projects"
          title="Rick and Morty application"
          description="Final project of the frontend subject 1 of the frontend specialization in Digital House. Using the Rick and Morty API with documentation. Technologies: TypeScript, Redux, Thunk, Jest and Testing Library."
          // buttonDemo="Demo →"
          // buttonHrefDemo="https://github.com/DiegoMarulandaB/ctd-esp-fe1-final"
          // hrefDemo="https://github.com/DiegoMarulandaB/ctd-esp-fe1-final"
          button="Github →"
        ...
        <ProjectsCardsCategoryTitle
          ...
          category="Personal Projects"
          title="Counter Click"
          description="Project inspired by the FreeCodeCamp course on basic React to apply key concepts in a practical environment, providing an interactive and functional experience for the user. Technologies: Vite compiler, React library."
          // buttonDemo="Demo →"
          // buttonHrefDemo="https://github.com/DiegoMarulandaB/click-counter-freecodecamp"
          // hrefDemo="https://github.com/DiegoMarulandaB/click-counter-freecodecamp"
          button="Github →"
