    ...
    <div className=" mb-[60px] max-w-[794px] ml-2 mx-1 mr-1">
      <div className="flex flex-wrap -mx-4 text-1xl">
        ...
        <ProjectsCardsCategoryTitle
          ...
          description="MVP, final project of the Certified Tech Developer degree at Digital House allows you to book tours and activities. Technologies: Git, Gitlab, CSS, React, Java V.17, JWT, MySQL, Jest, AWS."
          buttonDemo="Demo →"
        ...
        <ProjectsCardsCategoryTitle
          ...
          description="Basic React project to enhance the knowledge acquired. Provides an interactive and functional experience for the user. Technologies: Vite compiler, React library."
          buttonDemo="Demo →"
