            ...
            <div className=" mb-[60px] max-w-[794px] ml-2 mx-1 mr-1">
              <div className="flex flex-wrap -mx-4 text-1xl">
                <ProjectCards
                  ...
                  description="Browse all my repositories on GitHub, where you can discover a variety of projects from my programming training, both academic and my most relevant personal projects."
                  button="Github →"
