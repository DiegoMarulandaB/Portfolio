                ...
                <li className="mb-1">
                  <button
                    ...
                    className={`inline-block rounded-md py-3 px-3 text-1xl font-semibold transition md:py-3 lg:px-8  ${
                      showCard === 'all'
                        ? 'activeClasses bg-primary hover:text-purple-900 dark:text-slate-100 dark:hover:text-amber-200 transition-transform duration-150 ease-in-out hover:scale-125  mx-2 mr-2'
                        : 'inactiveClasses'
                    }`}
                  >
                    All Projects
