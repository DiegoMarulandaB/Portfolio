...
const ProjectCards: React.FC<ProjectCardsProps> = ({
  ...
  >
    <div className="flex flex-col items-center text-center text-white bg-gradient-to-r bg-white dark:bg-slate-600 rounded-3xl outline outline-offset-2 outline-slate-900 dark:outline-slate-50 opacity-90  px-4 py-4 mx-2 mr-2 mt-5 w-46 h-46">
