...
const MySkills = () => {
  return (
    <div className="md:w-1/2">
      <div className=" flex flex-col items-start text-start justify-start md:items-center md:text-center md:justify-center mr-4 font-extrabold capitalize text-4xl sm:text-6xl md:text-4xl lg:text-4xl xl:text-7xl mt-[-52px]">
        <h2>My Skills</h2>
      </div>
