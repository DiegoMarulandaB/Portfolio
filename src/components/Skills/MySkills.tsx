...
const MySkills = () => {
  return (
    <div className="md:w-1/2 mt-[-52px]">
      <div className=" flex flex-col items-start text-start justify-start md:items-center md:text-center md:justify-center mr-4 font-extrabold capitalize text-4xl sm:text-6xl md:text-4xl lg:text-4xl xl:text-7xl">
        <h2>My Skills</h2>
      </div>
      ...
      <div className="flex flex-col items-start text-start justify-start md:items-center md:text-center md:justify-center">
        <div className="grid grid-cols-3 md:grid-cols-2 gap-4 mt-4 md:w-3/3">
          <div>
            ...
            />
            <span className="justify-center text-1xl mx-auto mr-6 mt-6">Css</span>
          </div>
          <div>
            <Image
              src="/html5-icon.svg"
