      ...
      <div>
        <Slide offset="-200px 0px -200px 0px">
          <div className="flex flex-col items-center text-center border border-gray-800 rounded-2xl shadow bg-slate-50 dark:bg-slate-600 dark:border-slate-50 px-1 py-1 mx-2 mr-2 mt-6">
            ...
            <div className="mx-auto bg-slate-50  dark:bg-slate-600 rounded-b-lg shadow-xl overflow-hidden">
              <div className="relative z-10 px-2 py-2 -mt-2 text-center items-center justify-center mx-2 mr-2 w-26 text-1xl">
                ...
                <h3 className="mb-4 text-1xl text-slate-800 dark:text-slate-100">{description}</h3>
                <a
                  href={buttonHref}
                  target="_blank"
