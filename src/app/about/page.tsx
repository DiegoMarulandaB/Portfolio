              ...
              <div className="grid grid-cols-4 md:grid-cols-4 gap-4">
                ...
                <div>
                  <Image
                    ...
                    width={50}
                    height={50}
                    className="h-auto max-w-full px-1 py-2 mb-1 bg-neutral-200 dark:bg-slate-700 rounded-md border-2 border-slate-50 rounded-md border-2 border-slate-50 rounded-md text-lg xl:text-4xl"
                  />
                </div>
              ...
              <div className="grid grid-cols-5 md:grid-cols-4 gap-4">
                ...
                <div>
                  <Image
                    ...
                    width={50}
                    height={50}
                    className="h-auto max-w-full px-1 py-2 mb-1 bg-neutral-200 dark:bg-slate-700 rounded-md border-2 border-slate-50 rounded-md text-lg xl:text-4xl"
                  />
                </div>
