      ...
      <div className="pt-20 lg:pt-[100px] pb-12 lg:pb-[100px] overflow-hidden">
        <div className="flex flex-col text-center items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center -mx-4">
            ...
            <div className="flex flex-col text-center items-center justify-center">
              <div className="max-w-lg mx-auto my-10  bg-slate-50 dark:bg-slate-600 rounded-lg shadow-md p-5 ">
                ...
                <div className="mt-18 lg:mt-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mx-2 mr-2 mt-10">
                    <div className="flex flex-col text-center items-center justify-center ">
                      {/* card */}
              ...
              <div className="mt-18 lg:mt-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-2 mr-2 mt-10"></div>
              </div>
            </div>
          </div>
        </div>
