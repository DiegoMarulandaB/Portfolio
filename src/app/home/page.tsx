        ...
        <div className="flex flex-col text-center items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center -mx-4">
            ...
            <div
             ...
             center"
            >
              <div className="max-w-lg mx-2 mr-2 my-10   ">
                <img className="w-40 h-40 rounded-full mx-auto" src="/Diego.jpeg" alt="Profile picture" />
              ...
              <div className="text-center max-w-lg mx-2 mr-2 my-10 ">
                <img className="w-40 h-40 rounded-full mx-auto" src="/projects.png" alt="Profile picture" />
                <div className="mt-5">
                  <h2 className="text-center text-2xl font-semibold mt-3">Web development</h2>
                  <h3 className="text-center mt-5 text-xl font-semibold text-pink-600">Projects</h3>
