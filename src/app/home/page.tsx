      ...
      <div className="flex flex-col text-center items-end justify-center align-bottom space-x-4 mt-6 mr-40 mx-64">
        {ButtonAbout.map((project, index) => (
          <Link key={index} href={project.route}>
            ...
            hover:-translate-y-1 transition-transform cursor-pointer text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 rounded-md px-3 py-3 mb-8 w-40"
            >
      ...
      <div className="flex flex-col text-center items-end justify-center align-bottom space-x-4 mt-6 mr-40 mx-64">
        {ButtonProjects.map((project, index) => (
          <Link key={index} href={project.route}>
            ...
            //forma boton
            text-center inline-flex items-center
            hover:-translate-y-1 transition-transform cursor-pointer text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 rounded-md  px-3 py-3  mb-4 w-40"
            >
