      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className=" flex-col text-center items-center justify-center mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
          <a
            ...
            className="flex flex-col text-center items-center justify-center px-4 py-6 border transform transition-transform hover:-translate-y-1 cursor-pointer text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 rounded-r-lg"
          >
          ...
          <a
            ...
            className="flex flex-col items-center text-center px-4 py-6 border transform transition-transform hover:-translate-y-1 cursor-pointer text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 rounded-r-lg"
          >
            <AiOutlineTwitter className="icon text-white" size={40} />
            <span className="text-base font-medium text-white">Twitter</span>
